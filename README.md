...
- [`xmaxsdk-1.0.10.har`](https://github.com/XingMai/XmaxSDK-HarmonyOS/releases/download/1.0.10/xmaxsdk-1.0.10.har)
...
{
  "dependencies": {
    "@xmax/sdk": "file:./libs/xmaxsdk-1.0.10.har"
  }
}
```
