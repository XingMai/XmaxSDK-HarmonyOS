...
- [`xmaxsdk-1.0.8.har`](https://github.com/XingMai/XmaxSDK-HarmonyOS/releases/download/1.0.8/xmaxsdk-1.0.8.har)
...
{
  "dependencies": {
    "@xmax/sdk": "file:./libs/xmaxsdk-1.0.8.har"
  }
}
```
