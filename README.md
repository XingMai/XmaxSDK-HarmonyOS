...
- [`xmaxsdk-1.0.7.har`](https://github.com/XingMai/XmaxSDK-HarmonyOS/releases/download/1.0.7/xmaxsdk-1.0.7.har)
...
{
  "dependencies": {
    "@xmax/sdk": "file:./libs/xmaxsdk-1.0.7.har"
  }
}
```
