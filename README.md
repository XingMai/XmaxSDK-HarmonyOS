...
> [!WARNING]
> Never commit your Xmax API Key to version control. Provide it securely at runtime, or use a temporary key generated by the Xmax API. See [Authentication](https://platform.xmaxai.com/docs/authentication) for details.
