...
- [`xmaxsdk-1.0.9.har`](https://github.com/XingMai/XmaxSDK-HarmonyOS/releases/download/1.0.9/xmaxsdk-1.0.9.har)
...
{
  "dependencies": {
    "@xmax/sdk": "file:./libs/xmaxsdk-1.0.9.har"
  }
}
```
