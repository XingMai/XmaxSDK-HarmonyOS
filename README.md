...
- [`xmaxsdk-1.0.11.har`](https://github.com/XingMai/XmaxSDK-HarmonyOS/releases/download/1.0.11/xmaxsdk-1.0.11.har)
...
{
  "dependencies": {
    "@xmax/sdk": "file:./libs/xmaxsdk-1.0.11.har"
  }
}
```
...
`pause`, or `ended` value with `localVideoPlaybackState` or
