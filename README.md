...
- [`xmaxsdk-1.0.6.har`](https://github.com/XingMai/XmaxSDK-HarmonyOS/releases/download/1.0.6/xmaxsdk-1.0.6.har)
...
{
  "dependencies": {
    "@xmax/sdk": "file:./libs/xmaxsdk-1.0.6.har"
  }
}
```
